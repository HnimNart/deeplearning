...
module neural_network (R:real): network with t = R.t = {
  ...
  let connect_layers 'w1 'w2 'i1 'o1 'o2 'c1 'c2 'e1 'e2 'e  ((f1, b1, ws1): NN i1 w1 o1 c1 e e1 (apply_grad t))
                                                               ((f2, b2, ws2): NN o1 w2 o2 c2 e2 e (apply_grad t))
                                                               : NN i1 (w1,w2) (o2) (c1,c2) (e2) (e1) (apply_grad t) =
    ...
    (\(training) (w1, w2) (input) ->
                            ...
                            in ((c1, c2), res2),
     (\(_) f (w1,w2) (c1,c2) (error) ->
                            let (err2, w2') = b2 false f w2 c2 error
                            let (err1, w1') = b1 true f w1 c1 err2
                            in (err1, (w1', w2'))),
     (ws1, ws2))

  let predict  'i 'w 'g 'e1 'e2 'u 'o  ((f,_, w):NN ([]i) w ([]o) g e1 e2 u) (input:[]i) (classifier:activation_func o)  =
