...
module conv2d (R:real) : layer with t = R.t
  ...
  let forward (act:[]t -> []t) ((w_m, w_n):(i32, i32)) (stride:i32) (training:bool) ((w,b):weights) (input:input) : (cache, output) =
  ...
  let backward (act:[]t->[]t) (k:i32) (stride:i32) (first_layer:bool) ((w,_): weights) ((dims,input0, input1):cache) (error:error_in) : gradients =
